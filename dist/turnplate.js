...
var ReactTurnPlate = function (_React$Component) {
  ...
  _createClass(ReactTurnPlate, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { className: "turnplate-border", ref: "turnplateBorder", style: { background: "url(" + background_2 + ")" } },
        _react2.default.createElement(
          "div",
          {
        ...
        _react2.default.createElement("div", { style: { background: "url(" + image_spin + ")" }, className: "pointer", onClick: this.onRotate.bind(this) })
      );
    }
  }]);
